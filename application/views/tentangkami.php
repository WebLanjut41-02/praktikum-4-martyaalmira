        ...
        <div class="row align-items-center">
          <div class="col-lg-6">
            <div class="p-5"><br><br><br>
              <img class="img-fluid rounded-circle" src="<?php echo base_url();?>assets/img/forum.jpg" width="300px" height="200px"alt="">
            </div>
          </div>
          <div class="col-lg-6">
            <div class="p-5">
              <h2 class="display-4"><u>Forum Diskusi</u></h2>
              
               <p>Diskusi antar tentor dengan siswa menjadi lebih asik.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6 order-lg-2">
            <div class="p-5">
              <img class="img-fluid rounded-circle" src="<?php echo base_url();?>assets/img/live.png" alt="">
            </div>
          </div>
          <div class="col-lg-6 order-lg-1">
            <div class="p-5">
              <h2 class="display-4"><u>Nonton Video</u></h2>
                
                <p>
                  Nonton video secara langsung yang diberikan oleh tentor pasti akan lebih paham dan jelas.
                </p>
            </div>
          </div>
        </div>
