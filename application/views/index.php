    ...
    <header class="masthead text-center text-white">
      <div class="masthead-content">
        <div class="container">
          ...
          <h2 class="masthead-subheading mb-0">Bimbingan Belajar Online</h2>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6 order-lg-2">
            <div class="p-5">
              <img class="img-fluid rounded-circle" src="<?php echo base_url();?>assets/img/logo.png" alt="">
            </div>
          </div>
          <div class="col-lg-6 order-lg-1">
            <div class="p-5">
              <h2 class="display-4"><u>Tentang</u></h2>
              
                <p>Go Smart dirilis tahun 2019. Go Smart ini adalah Aplikasi Bimbingan Belajar Online berbasis Web yang pastinya akan sangat membantu siswa kelas 12 SMA dalam belajar. Dan aplikasi ini akan membantu siswa dalam menyukseskan Ujian Nasional dan SBMPTN karena terdapat fasilitas yang banyak.</p>
              </p>
            </div>
          </div>
        </div>
