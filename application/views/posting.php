...
<html lang="en">
  ...
  <body>
    ...
    <body>
      <form action="<?php echo base_url(); ?>index.php/welcome/prosesposting" method="POST">
        <body><br><br><br><br>
          <br>
    ...
    <div class="form-group">
              ...
              <input type="text" name="judul" class="form-control" id="judul" aria-describedby="judul" placeholder="" name="judul" required="">
              </div>

              <div class="form-group">
              <label for="status">Status Anda</label>
              <input type="text" class="form-control" id="status" aria-describedby="status" placeholder="" name="status" required="">
              </div>

              <div class="form-group">
              
              <input type="submit" class="form-control" id="submit" aria-describedby="submit" placeholder="" name="submit" >
              </div>
    </form>
    <br>
    <?php if(isset($judul)){?>
