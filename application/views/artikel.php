      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6 order-lg-2">
            <div class="p-5">
              <img class="img-fluid rounded-circle" src="<?php echo base_url();?>assets/img/un.jpg" width="200px" height="400px"alt="">
            </div>
          </div>
          <div class="col-lg-6 order-lg-1">
            <div class="p-5">
              <h2 class="display-4"><u>Sukses UN</u></h2>
                
                <p>
                  Latihan Soal untuk Ujian Nasional.
                </p>
            </div>
          </div>
        </div>
    ...
    <section>
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6">
            <div class="p-5">
              <img class="img-fluid rounded-circle" src="<?php echo base_url();?>assets/img/sbmptn.jpg" width="300px" height="500pxalt="">
            </div>
          </div>
          <div class="col-lg-6">
            <div class="p-5">
              <h2 class="display-4"><u>Sukses SBMPTN</u></h2>
                
                <p>
                  Kumpulan soal latihan SBMPTN.
                </p>
          </div>
        </div>
      </div>
    ...
    <section>
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6 order-lg-2">
            <div class="p-5">
              <img class="img-fluid rounded-circle" src="<?php echo base_url();?>assets/img/to.jpg" alt="">
            </div>
          </div>
          <div class="col-lg-6 order-lg-1">
            <div class="p-5">
              <h2 class="display-4"><u>Try Out Online</u></h2>
                
                <p>
                  Latihan soal Try Out Online.
                </p>
          </div>
      </div>
    </div>
