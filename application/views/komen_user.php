...
<html lang="en">
  ...
  <body>
    ...
    <body>
      ...
      <form action="<?php echo base_url()?>index.php/welcome/proses_komen_user" method="post">
        <table>
          <tr>
            <td>Nama</td>
            <td> : </td>
          ...
          <tr>
            <td> <button type="submit" class="btn btn-primary" name="submit">Komentar</button></td>
          </tr>
    ...
    <div class="card text-center bg-info">
      ...
      <div class="card-body">
        ...
        <p class="card-text"><?php echo $komen; ?></p>
